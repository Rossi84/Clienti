Inserimento istanza di conciliazione VSP (Modello VSP)
======================================================

In base ai disservizi selezionati ed ai fornitori di servizi video sharing coinvolti l'istanza di conciliazione potrà seguire tre distinti iter:
...
.. figure:: /media/nuova_conciliazione_vsp.png
   :align: center
   :name: nuova-conciliazione-vsp
...
- Dati relativi alla **controversia**:
        - Operatore/ in controparte: selezionare uno o più fornitori di servizi video sharing coinvolti nella controversia.
...
.. figure:: /media/vsp_formulario.png
   :align: center
   :name: vsp-formulario
   :alt: Formulario
